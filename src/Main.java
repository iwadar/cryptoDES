public class Main {
    ...
    private static final int[] inverseIP = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47,
    ...
    // 56 бит -> 48 бит
    private static final int[] KE_1 = { 57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34,
            26, 18, 10, 2, 59, 51, 43, 35, 27, 19, 11, 3, 60, 52, 44, 36, 63,
            55, 47, 39, 31, 23, 15, 7, 62, 54, 46, 38, 30, 22, 14, 6, 61, 53,
            45, 37, 29, 21, 13, 5, 28, 20, 12, 4 };

    // сдвиг
    private static final int[] KShift = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };

    private static final int[] KE_2 = { 14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10,
